    ...
    "he": {
        ...
        "scripts": {
            "nikuy": {
                ...
                "desc": "יש להעלות דוח נוכחות מפורט חודשי הכולל סימני * או ?. המערכת תחזיר את אותו הדוח לאחר ניקוי הסימנים, מוכן להמשך עבודה.",
            ...
            "flamingo_payroll": {
                ...
                "desc": "יש להעלות דוח מפורט חודשי הכולל שדה של תעריף שעתי קבוע. המערכת תפיק דוח שכר לעובדים, כולל חישוב שכר וסיכומים מתקדמים. מיועד בעיקר לחברות כוח אדם.",
            ...
            "matan_missing": {
                "name": "דוח שעות חסר",
                "desc": "יש להעלות דוח חודשי מרוכז של שעות תקן מול שעות החוסר. המערכת מנתחת את הנתונים ומציגה רק את העובדים שעומדים בתנאי הסינון שהוגדרו: יותר מ־X שעות חוסר, פחות מ־Y שעות חוסר, או שילוב של שני התנאים ביחס לתקן החודשי שלהם.",
